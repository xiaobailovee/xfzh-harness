...
export const en = {
  ...
  modelSupportsImages: 'Image input',
  modelReasoningLevels: 'Thinking levels',
  modelReasoningLevelsPlaceholder: 'low\nmedium\nhigh',
  modelReasoningLevelsHint: 'One canonical id per line: off, minimal, low, medium, high, xhigh, max.',
  modelReasoningInvalid: 'Each line must be a unique thinking level (off, minimal, low, medium, high, xhigh, max), and at least one level besides off is required.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelSupportsImages: '支持图片输入',
  modelReasoningLevels: '思考等级',
  modelReasoningLevelsPlaceholder: 'low\nmedium\nhigh',
  modelReasoningLevelsHint: '每行一个等级 id：off、minimal、low、medium、high、xhigh、max。',
  modelReasoningInvalid: '每行必须是唯一的思考等级（off、minimal、low、medium、high、xhigh、max），且除 off 外至少再写一个等级。',
  customApi: 'API 协议',
  customApiUnset: '未选择',
